...
export const SPELLS: Record<SpellId, SpellDef> = {
  1: { name: "Bolt", damage: 8, cooldownMs: 800, range: 8 },
  2: { name: "Strike", damage: 20, cooldownMs: 2500, range: 6 },
};

export const ENEMY_STATS = {
  melee: { maxHp: 40, damage: 8, range: 1.8, intervalMs: 1500 },
  caster: { maxHp: 25, damage: 6, range: 10, cooldownMs: 2200, projectileSpeed: 6, hitRadius: 0.6 },
} as const;
